...
This is an example that demonstrates how to enter and exit fullscreen.

The code is designed to be simple and easy to follow.

## Overview

This example displays a simple texture, if you hit 'F' you will enter full screen, if you hit 'E' you will exit
fullscreen.
