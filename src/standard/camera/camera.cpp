...
JamJar::Standard::Camera::Camera(Color backgroundColor, Vector2D viewportPosition, Vector2D viewportScale,
                                 Vector2D virtualScale)
    : Component(JamJar::Standard::Camera::CAMERA_KEY), m_backgroundColor(backgroundColor),
